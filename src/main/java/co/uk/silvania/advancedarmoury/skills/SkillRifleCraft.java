...
public class SkillRifleCraft extends SkillLevelBase implements IExtendedEntityProperties {
	
	public static String staticSkillId;

	public SkillRifleCraft(EntityPlayer player, String skillID) {
		super(skillID);
	...
	public static final void register(EntityPlayer player) {
		player.registerExtendedProperties(SkillRifleCraft.staticSkillId, new SkillRifleCraft(player, staticSkillId));
	}
	...
	@Override public String shortName() { return "RIFL-C"; }
	@Override public String skillName() { return "Rifle Crafting"; }
	@Override public String nameFormat() { return "\u00A76"; }
	@Override public int xpBarColour() { return 16755200; }

	@Override
	public void addDescription() {
		description.add("Ability to create rifles");
		description.add("Level up to craft improved rifles,");
