...
public class SkillEnergyPistols extends SkillLevelBase implements IExtendedEntityProperties {
	
	public static String staticSkillId;
	
	public SkillEnergyPistols(EntityPlayer player, String skillID) {
		super(skillID);
	...
	public static final void register(EntityPlayer player) {
		player.registerExtendedProperties(SkillEnergyPistols.staticSkillId, new SkillEnergyPistols(player, staticSkillId));
	}
	...
	@Override public String shortName() { return "E-PSTL"; }
	@Override public String skillName() { return "Energy Pistols"; }
	@Override public String nameFormat() { return "\u00A72"; }
	@Override public int xpBarColour() { return 43520; }
	
	@Override
	public void addDescription() {
		description.add("Proficiency with Energy Pistols.");
