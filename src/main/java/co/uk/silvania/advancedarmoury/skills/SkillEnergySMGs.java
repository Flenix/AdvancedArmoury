...
public class SkillEnergySMGs extends SkillLevelBase implements IExtendedEntityProperties {
	
	public static String staticSkillId;
	
	public SkillEnergySMGs(EntityPlayer player, String skillID) {
		super(skillID);
	...
	public static final void register(EntityPlayer player) {
		player.registerExtendedProperties(SkillEnergySMGs.staticSkillId, new SkillEnergySMGs(player, staticSkillId));
	}
	...
	@Override public String shortName() { return "E-SMG"; }
	@Override public String skillName() { return "Energy Sub-Machine Guns"; }
	@Override public String nameFormat() { return "\u00A75"; }
	@Override public int xpBarColour() { return 11141290; }
	
	@Override
	public void addDescription() {
		description.add("Proficiency with Energy SMGs.");
