...
public class ItemGenericComponent extends ItemComponent {
	...
	protected boolean fireRate;
	protected boolean power;
	protected boolean range;
	
	//MaterialName durability weight acc textcol itemcol firerate oredict power range rarity
	public ItemGenericComponent(String componentName, String displayName, String identifier, double size, boolean acc, boolean fireRate, boolean power, boolean range) {
		super(componentName, displayName, identifier, size);
