...
public class WalkwayFenceMilitaryBase extends DecorativeMilitaryBase {

	public WalkwayFenceMilitaryBase(String textureName, String blockType) {
	...
	public boolean checkConnections(World world, int x, int y, int z, int targetMeta, int meta) {
		...
		if (world.getBlock(x, y, z) instanceof WalkwayFenceMilitaryBase || world.getBlock(x, y, z) instanceof WalkwayStairsMilitaryBase) {
			return true;
		}
		
		if (targetMeta >= 0) {
			if (world.getBlock(x, y - 1, z) instanceof WalkwayStairsMilitaryBase || world.getBlock(x, y, z) instanceof WalkwayStairsMilitaryBase) {
