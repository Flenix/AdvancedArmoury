package co.uk.silvania.advancedarmoury.gun;
...
public class EntityItemGun extends EntityItem {

	public EntityItemGun(World p_i1582_1_) {
		super(p_i1582_1_);
		// TODO Auto-generated constructor stub
	}
	
	public EntityItemGun(World world, double x, double y, double z, ItemStack stack) {
		super(world, x, y, z);
    ...
    public EntityItemGun(World p_i1709_1_, double p_i1709_2_, double p_i1709_4_, double p_i1709_6_)
    {
        super(p_i1709_1_);
        this.health = 5;
    ...
    public EntityItemGun(World p_i1710_1_, double p_i1710_2_, double p_i1710_4_, double p_i1710_6_, ItemStack p_i1710_8_)
    {
    ...
    public EntityItemGun(World p_i1711_1_)
    {
        super(p_i1711_1_);
        this.health = 5;
        this.hoverStart = (float)(Math.random() * Math.PI * 2.0D);
    ...
    public void onUpdate()
    {
        ...
        {
            *//*if (stack.getItem().onEntityItemUpdate(this)) TODO
            {
                return;
            }*//*
        }
     ...
     */
    /* TODO public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
