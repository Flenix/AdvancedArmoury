...
public class M4CarbineBling extends GunFrame {
	...
	public void getSubItems(Item stack, CreativeTabs tab, List list) {
		...
		ItemStack barrel = new ItemStack(AAItemComponents.barrelGold);
		...
		item.stackTagCompound.setFloat("accuracy", EnumMaterial.GOLD.accuracy);
		...
		inventory.setInventorySlotContents(2, new ItemStack(AAItemAssaultComponents.assaultBoltDarisin)); //bolt
		inventory.setInventorySlotContents(3, new ItemStack(AAItemAssaultComponents.assaultBoltCarrierSteel)); //boltCarrier
		inventory.setInventorySlotContents(4, new ItemStack(AAItemAssaultComponents.assaultChargingHandleDarisin)); //chargingHandle
		...
		inventory.setInventorySlotContents(14, new ItemStack(AAItemComponents.triggerDarisin)); //trigger
		inventory.setInventorySlotContents(15, new ItemStack(AAItemComponents.fireSelectorDarisin)); //fire selector
		
		inventory.setInventorySlotContents(16, new ItemStack(AAItemModifierCores.coreSimpleChamberNet)); //Modifier
		
		inventory.setInventorySlotContents(17, new ItemStack(AAItemAssaultComponents.assaultReceiverM4Gold)); //receiver
		inventory.setInventorySlotContents(18, new ItemStack(AAItemAssaultComponents.assaultStockM4Gold)); //stock
		inventory.setInventorySlotContents(19, new ItemStack(AAItemAssaultComponents.assaultFrontEndM4Gold)); //frontEnd
		list.add(item);
	}
