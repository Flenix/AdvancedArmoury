...
public class WalkwayFence extends DecorativeBlockAA {

	public WalkwayFence(String textureName, String blockType) {
	...
	public boolean checkConnections(World world, int x, int y, int z, int targetMeta, int meta) {
		...
		if (targetMeta >= 0) {
			if (world.getBlock(x, y - 1, z) instanceof WalkwayStairs || world.getBlock(x, y, z) instanceof WalkwayStairs) {
