...
public class SkillLMGs extends SkillLevelBase implements IExtendedEntityProperties {
	
	public static String staticSkillId;
	
	public SkillLMGs(EntityPlayer player, String skillID) {
		super(skillID);
	...
	public static final void register(EntityPlayer player) {
		player.registerExtendedProperties(SkillLMGs.staticSkillId, new SkillLMGs(player, staticSkillId));
	}
	...
	@Override public String shortName() { return "LMG"; }
	@Override public String skillName() { return "Light Machine Guns"; }
	@Override public String nameFormat() { return "\u00A7a"; }
	@Override public int xpBarColour() { return 5635925; }
	
	@Override
	public void addDescription() {
		description.add("Proficiency with Light Machine Guns.");
