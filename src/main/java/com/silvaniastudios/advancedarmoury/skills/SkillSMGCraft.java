...
public class SkillSMGCraft extends SkillLevelBase implements IExtendedEntityProperties {
	
	public static String staticSkillId;

	public SkillSMGCraft(EntityPlayer player, String skillID) {
		super(skillID);
	...
	@Override public String shortName() { return "SMG-C"; }
	@Override public String skillName() { return "SMG Crafting"; }
	@Override public String nameFormat() { return "\u00A75"; }
	@Override public int xpBarColour() { return 11141290; }

	@Override
	public void addDescription() {
		description.add("Ability to create Sub-Machine Guns");
		description.add("Level up to craft improved SMGs,");
