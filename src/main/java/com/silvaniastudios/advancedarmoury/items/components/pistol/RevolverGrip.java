...
public class RevolverGrip extends ReceiverCasing {

	public RevolverGrip(String componentName, String displayName, float xSize,
		...
		super("small", "revolver", componentName, displayName, xSize, ySize, zSize, barrelX, barrelY, barrelZ, stockX, stockY,
